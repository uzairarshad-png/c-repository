...
int main() {
    ...
    cout << left << setw(20) << "Fee per Unit" << ": Rs. " << fixed << setprecision(2) <<
        feePerUnit << endl;
    cout << left << setw(20) << "Total" << ": Rs. " << fixed << setprecision(2) << total <<
        endl;
    cout << left << setw(20) << "Tax (5%)" << ": Rs. " << fixed << setprecision(2) << tax <<
        endl;
    cout << left << setw(20) << "Grand Total" << ": Rs. " << fixed << setprecision(2) <<
        grandTotal << endl;
    cout << "===============================" << endl;
    return 0;
}